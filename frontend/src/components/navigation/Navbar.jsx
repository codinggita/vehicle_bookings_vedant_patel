...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between w-full h-16 px-4 md:px-6 bg-slate-950/65 backdrop-blur-md border-b border-slate-800/80">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={onMenuClick}
          className="p-2 text-slate-400 hover:text-slate-200 hover:bg-slate-900/60 rounded-xl lg:hidden focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all duration-200"
      ...
      <div className="hidden md:flex items-center flex-1 max-w-md mx-6">
        <div className="relative w-full">
          ...
          <input
            ...
            disabled
            className="w-full pl-10 pr-4 py-2 text-sm rounded-xl bg-slate-900/50 border border-slate-800/80 text-slate-300 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all duration-200 cursor-not-allowed"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            disabled
            className="p-2.5 text-slate-400 hover:text-indigo-400 hover:bg-indigo-500/5 border border-transparent hover:border-indigo-500/10 rounded-xl transition-all duration-200 relative cursor-not-allowed group"
          ...
          >
            ...
            <span className="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-indigo-500 ring-2 ring-slate-950 animate-pulse" />
          </button>
        </div>
